...
public class AddContact extends MouseAdapter implements ActionListener
{
    ...
    public void actionPerformed(ActionEvent ae) 
    {
        ...
        if (name.equals("") || (cno.equals(""))){
            ...
            JOptionPane.showMessageDialog(jf_AddContact, "Contact has been added","Succes Message", JOptionPane.INFORMATION_MESSAGE);
            int status = JOptionPane.showConfirmDialog(jf_AddContact, "Do you want to add more contact?", "Confirmation", JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE);
            if (status == 0) {
                jf_AddContact.setVisible(true);
            }
            else{
